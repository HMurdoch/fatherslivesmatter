...
const Home: React.FC = () => {
    return (
        <>
            ...
            <StatBar
                items={[
                    { label: "Children do best when both safe parents are lovingly involved.", value: "Principal 1" },
                    { label: "FLM supports fathers facing alienation, obstruction and false allegations.", value: "Principal 2" },
                    { label: "We turn private pain into organised action and evidence-based change.", value: "Principal 3" }
                ]}
            />
            ...
            <Section variant="light">
                ...
                <p>
                    ...
                    question first: <strong>"What is best for this child in the long
                        run?"</strong>
                </p>
            </Section>
        </>
